    ...
    for i in range(config['epoch']):
      ...
      try:
        while True:
          ...
          if step % 1000 == 0:
            speed = round(step / (time.time() - epoch_time))
            print("{} Epoch {}, Iter {}, Loss {:.5f}, Speed {:d} steps/sec".format(time.asctime(), i, step, ret[0], speed))
          step += 1
...
if __name__ == "__main__":
  argparser = argparse.ArgumentParser("Train Ego Bipartite SAGE.")
  argparser.add_argument('--batch_size', type=int, default=128)
  argparser.add_argument('--u_attr_types', type=list, default=[("string", 10000)])
  argparser.add_argument('--u_attr_dims', type=list, default=[128])
  argparser.add_argument('--i_attr_types', type=list, default=[("string", 10000)])
  argparser.add_argument('--i_attr_dims', type=list, default=[128])
  argparser.add_argument('--hidden_dim', type=int, default=128)
  argparser.add_argument('--output_dim', type=int, default=128)
  argparser.add_argument('--u_nbrs_num', type=list, default=[10, 5])
  argparser.add_argument('--i_nbrs_num', type=list, default=[10])
  argparser.add_argument('--neg_num', type=int, default=5)
  argparser.add_argument('--learning_rate', type=int, default=0.0001)
  argparser.add_argument('--epoch', type=int, default=10)
  argparser.add_argument('--agg_type', type=str, default='mean')
  argparser.add_argument('--drop_out', type=int, default=0.0)
  argparser.add_argument('--sampler', type=str, default='random')
  argparser.add_argument('--neg_sampler', type=str, default='in_degree')
  argparser.add_argument('--temperature', type=int, default=0.07)
